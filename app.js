...
// Подробная документация: см. DECK_LAYOUT_SYSTEM.md
const DECK_FLIP_TYPES = {
    // Тип 1: Колоды с цитатами и уточняющими вопросами
    // Верстка: Верхняя часть - уточняющий вопрос, Нижняя часть - цитата с автором (курсив, 13px)
...
// Тип 1: Колоды с цитатами и уточняющими вопросами
// Верстка: Верхняя часть (main-question-back) - уточняющий вопрос
//          Нижняя часть (additional-question-back) - цитата с автором (курсив, 13px)
// См. DECK_LAYOUT_SYSTEM.md для подробностей
